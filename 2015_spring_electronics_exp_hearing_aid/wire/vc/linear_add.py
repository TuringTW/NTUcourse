...
#pyAudio
p = pyaudio.PyAudio()
old = np.zeros(freqsize, dtype=np.complex128)

def callback(in_data, frame_count, time_info, status):
	global RATE, shift_ratio, freq, s_freq, audio_size, freqsize, volume, linear_shift, old, delay
	# preprocessing 
